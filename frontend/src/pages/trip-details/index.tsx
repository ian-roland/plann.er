            ...
            <main className="flex gap-16 px-4">
                ...
                <div className="w-80 space-y-6">
                    ...
                    <div className="space-y-6">
                            ...
                            <div className="flex items-center justify-between gap-4">
                                <div className="space-y-1.5">
                                    ...
                                    <a href="#" className="block text-xs text-zinc-400 truncate hover:text-zinc-200">
                                        https://www.airbnb.com.br/rooms/1187812680552063705
                                    </a>
                                </div>
                        ...
                        <button className="bg-zinc-800 text-zinc-200 rounded-lg w-full px-5 justify-center h-11 font-medium flex items-center gap-2 hover:bg-zinc-700">
                            <Plus className="size-5" />
                            Cadastrar novo link
                    ...
                    <div>
                        <div className="space-y-6">
                            ...
                            <div className="space-y-5">
                                ...
                                <div className="flex items-center justify-between gap-4">
                                    <div className="space-y-1.5">
                                        <span className="block font-medium text-zinc-100">Bruce Wayne</span>
                                        <span className="block text-sm text-zinc-400 truncate">
